  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">BTP Phase II · IIT Tirupati CEE · NH-71 Instrumented Pavement</p>
      </div>
      ...
      <div className="card bg-primary text-primary-foreground">
        ...
        <p className="text-sm text-primary-foreground/80">Advisor: Prof. B. Krishna Prapoorna · IIT Tirupati · Department of Civil & Environmental Engineering</p>
      </div>

      {sections.map((section, i) => (
        <div key={i} className="card">
          <h3 className="card-title flex items-center gap-2">
            <span className="w-6 h-6 rounded-full bg-primary text-primary-foreground text-xs flex items-center justify-center font-medium">{i + 1}</span>
            {section.title}
          </h3>
